...
/*
1. We must iterate over existing roles and create a different assume role policy for each
   of them
2. In each role policy, under identifiers add only the users that have that specific
   listed in their "roles" list
*/
